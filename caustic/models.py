...
class PointSourcePointLens(pm.Model):
    ...
    def __init__(self, data):
        ...
        super(PointSourcePointLens, self).__init__()
...
class PointSourcePointLensWhiteNoise(PointSourcePointLens):
    #  override __init__ function from pymc3 Model class
    def __init__(self, data):
        # Most variables are defined in the parent class
        super(PointSourcePointLensWhiteNoise, self).__init__(data)
...
class PointSourcePointLensMatern32(PointSourcePointLens):
    def __init__(self, data):
        ...
        self.logp_sigma = pm.Deterministic('logp_sigma',
            BoundedNormal.dist(mu=0., sd=3).logp(self.sigma))
        self.logp_rho = pm.Deterministic('logp_rho',
            pm.InverseGamma.dist(alpha=invgamma_a, 
                beta=invgamma_b).logp(self.sigma))
